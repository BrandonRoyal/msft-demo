...
docker run --name demo_proxy --restart always --link demo_web:web --link demo_api:api -v "./proxy/nginx.conf:/conf/nginx.conf" -p 80:80 -d brandonroyal/demo_nginx:latest